package com.example.greeningapp.shop;
...
import com.example.greeningapp.Cart.CartActivity;
...
import com.example.greeningapp.quiz.QuizActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDonation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ShoppingMainActivity.this, OrderHistoryActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ShoppingMainActivity.this, ReviewActivity.class);
                startActivity(intent);
            }
        });
